...
|---|---|---|---|
| [tidsro](https://github.com/malinfossum/tidsro) | A calm, local-first desktop timer & alarm for Windows - never a flashy notification. | C# | 14 Jun |
| [kenaz](https://github.com/malinfossum/kenaz) | Private, local-first daily wellbeing check-in in C# - compassionate reflection, not passive tracking. | C# | 14 Jun |
| [ignite](https://github.com/malinfossum/ignite) | ADHD-friendly, open-source task app. A small flame, kept going. | JavaScript | 10 Jun |
...
**Stats:** 21 public repos · Top languages: C#, JavaScript, CSS · Last updated 2026-06-14 (UTC)
<!-- DASHBOARD:END -->
